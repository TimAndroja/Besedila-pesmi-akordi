...
function ljudske_pesmi({searchResults}) {
  ...
  return (
    <Layout>
      ...
      <h2>Ljudske pesmice, Slovenska ljudska glasba</h2>
      <p style={{ textAlign:"justify", lineHeight:"1.4"}}>Dobrodošli v kategoriji Ljudeske pesmi. Ponujamo vam veliko zbirko akordov za kitaro, klavir in druge inštrumente. Vabimo, da tudi vi dodate svoje akorde ali tablature za kakšno ljudsko pesem in tako nam, vam in vsem drugim omogočite obilo zabave pri igranju in učenju besedil pesmi in akordov. Dodajanje svojega besedila je mogoče v orodni vrstici na zavihku  <Link href="/dodaj_akorde"> Dodaj svoje
