...
function narodno_zabavna_glasba({searchResults}) {
  ...
  return (
    <Layout>
      ...
      <p style={{margin:"50px 5%", textAlign:"justify", lineHeight:"1.4"}}>Dobrodošli v kategoriji Narodno zabavna glasba. Ponujamo vam veliko zbirko akordov za kitaro, klavir in druge inštrumente. Vabimo, da tudi vi dodate svoje akorde ali tablature za kakšno slovensko narodno zabavno pesem in tako nam, vam in vsem drugim omogočite obilo zabave pri igranju in učenju besedil pesmi in akordov. Dodajanje svojega besedila je mogoče v orodni vrstici na zavihku  <Link href="/dodaj_akorde"> Dodaj svoje
