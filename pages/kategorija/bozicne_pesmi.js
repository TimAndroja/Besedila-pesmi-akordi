...
function bozicne_pesmi({searchResults}) {
  ...
  return (
    <Layout>
      ...
      <p style={{margin:"50px 5%", textAlign:"justify", lineHeight:"1.4"}}>Dobrodošli v kategoriji Božične pesmi. Ponujamo vam veliko zbirko akordov za kitaro, klavir in druge inštrumente. Vabimo, da tudi vi dodate svoje akorde ali tablature za kakšno božično pesem in tako nam, vam in vsem drugim omogočite obilo zabave pri igranju in učenju besedil pesmi in akordov. Dodajanje svojega besedila je mogoče v orodni vrstici na zavihku  <Link href="/dodaj_akorde"> Dodaj svoje
Besedilo/Akorde</Link>. Če rabite pomoč pri igranju kitare ali pa vas morda zanima kaj drugega z glasbenega področja, vam na začetni strani ponujamo glasbene članke, od onsnovnih akordov za kitaro, video lekcij za učenje kitare, do malo bolj teoretičnih tem kot kvintni krog za iskanje akordov, ali pa morda članek za nakup nove akustične oziroma električne kitare ali klavirja(klaviature). Veliko srče pri iskanju pesmi, ki ustreza tebi v kategoriji božične pesmi!
</p>
<p style={{margin:"50px 5%", textAlign:"justify", lineHeight:"1.4"}}>Božične pesmi, so pesmi, ki nas spremljajo okoli 25. decembra oziroma božiča. Pesmi so veslo obarvane in nam pripeljejo toplo božično vzdušje v hladni zimi. Med obdobjem božiča običajno postavimo smreko in jaslice, pečemo piškote in se družimo z družino oziroma najbljižnimi, med tem pa nas spremljajo božične pesmice. Veliko božičnih pesmi je narejenih tudi za otroke, saj je božič namenjen družinskemu druženju in veselju. Veliko besedil pesmi in akordov najdete tudi na tem portalu, pod to rubriko pa sodijo vse pesmi z akordi ki obsegajo obdobje božiča in novega leta.
</p>
    </Layout>
  );
}
