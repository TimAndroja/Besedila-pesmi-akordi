...
function slovenske_pesmi({searchResults}) {
  ...
  return (
    ...
    <p style={{margin:"50px 5%", textAlign:"center", lineHeight:"1.4"}}>Dobrodošli v kategoriji Slovenske pesmi. Ponujamo vam veliko zbirko akordov za kitaro, klavir in druge inštrumente. Vabimo, da tudi vi dodate svoje akorde ali tablature za kakšno slovensko pesem in tako nam, vam in vsem drugim omogočite obilo zabave pri igranju in učenju besedil pesmi in akordov. Dodajanje svojega besedila je mogoče v orodni vrstici na zavihku  <Link href="/dodaj_akorde"> Dodaj svoje
...
<div style={{textAlign:"center", margin:"auto"}}>
  ...
  <img src="/Slovenske-pesmi-besedilo-pesmi-akordi-za-kitaro.jpg" alt="Slovenske-pesmi-besedilo-pesmi-akordi-za-kitaro" />
  </div>
    </Layout>
  );
}
